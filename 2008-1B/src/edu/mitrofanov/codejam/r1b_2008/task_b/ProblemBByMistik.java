...
public class ProblemBByMistik {
	...
	void doMain() throws Exception {
		Scanner sc = new Scanner(new FileReader("resources/B-large-practice.in"));
		PrintWriter pw = new PrintWriter(new FileWriter("resources/B-large-practice-mystic.out"));
